...
import { ArrowRight, Cpu, Eye, Network, Shield, Radar, Server, Gauge, Brain } from 'lucide-react';
...
{/* <div className="mt-8 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Section
        title="Demos"
        subtitle="Interactive examples of edge-based perception and reconstruction."
      >
